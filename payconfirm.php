                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">             
                        <div class="col-md-12 text-center">
                            <h3 class="col-md-12" style="font-weight:bold;text-decoration:underline"> PAYMENT CONFIRMATION </h3>
                        </div> 
                        <div class="row" >
                            <div class="col-md-12">
                                <div class="col-md-8 col-md-offset-2" style="margin-top:50px">                               
                                    ...
                                    <form id="paymentform" method="POST" action="online.php">    
                                        ...
                                        <div class="col-md-12 text-center" style="margin-top: 20px"> 
                                            <i>Click the button if trasaction was successful</i>
                                        </div>  
                                        <div class="col-md-6 col-md-offset-3" style="margin-top: 30px"> 
                                            <button type="submit" class="btn btn-block btn-primary">I HAVE PAID</button>
                                        </div>  
                                    </form>  
